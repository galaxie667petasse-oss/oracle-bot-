...
ESSENTIAL_FILES = [
    ...
    "docs/event_lifecycle_policy.md",
    "docs/near_close_scheduler.md",
    "docs/result_capture_workflow.md",
    "docs/shadow_progress_dashboard.md",
    "docs/odds_autopilot_dryrun.md",
    "docs/source_coverage_strategy.md",
    "docs/api_football_matchday_probe.md",
    "docs/api_football_odds_enrichment.md",
    "docs/api_football_same_day_runner.md",
    "docs/api_football_same_day_runner_fix.md",
    "docs/near_close_today_helper.md",
    "docs/manual_betclic_intake.md",
    "docs/active_sports_discovery.md",
    "docs/historical_clv_import_workflow.md",
    "docs/evidence_acceleration_strategy.md",
    "docs/api_football_results_workflow.md",
    "docs/near_close_batch_runner.md",
    "docs/proof_dashboard.md",
    "docs/api_football_next_days_runner.md",
    "docs/near_close_window_planner.md",
    "docs/post_match_results_runner.md",
    "docs/football_data_free_importer.md",
    "docs/data_subscription_evaluator.md",
    "docs/daily_operations_runner.md",
...
MAIN_TESTS = [
    ...
    "test_event_lifecycle_manager.py",
    "test_near_close_scheduler.py",
    "test_result_capture_helper.py",
    "test_shadow_progress_dashboard.py",
    "test_odds_autopilot_dryrun.py",
    "test_the_odds_active_sports.py",
    "test_source_coverage_report.py",
    "test_api_football_fixtures_adapter.py",
    "test_api_football_matchday_probe.py",
    "test_api_football_valid_odds_selector.py",
    ...
    "test_historical_odds_schema_detector.py",
    "test_historical_clv_importer.py",
    "test_historical_clv_backtester.py",
    "test_api_football_results_adapter.py",
    "test_shadow_result_matcher.py",
    "test_near_close_batch_runner.py",
    "test_proof_dashboard.py",
...
IMPORT_MODULES = [
    ...
    "near_close_scheduler",
    "result_capture_helper",
    "shadow_progress_dashboard",
    "odds_autopilot_dryrun",
    "the_odds_active_sports",
    "source_coverage_report",
    "api_football_fixtures_adapter",
    "api_football_matchday_probe",
    "api_football_valid_odds_selector",
    ...
    "historical_odds_schema_detector",
    "historical_clv_importer",
    "historical_clv_backtester",
    "api_football_results_adapter",
    "shadow_result_matcher",
    "near_close_batch_runner",
    "proof_dashboard",

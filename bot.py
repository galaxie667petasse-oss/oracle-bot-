...
# ── 12 AGENTS SPÉCIALISÉS (très puissant) ───────────────────────────────────
AGENTS = [
    {"id":"tact", "n":"Tacticien", "e":"🧠", "s":"Expert tacticien. Formations, pressing, transitions, duel de styles. 80 mots max. Français."},
    {"id":"stat", "n":"Statisticien", "e":"📊", "s":"Stats + xG + forme + H2H + buts marqués/encaissés. 80 mots max. Français."},
    {"id":"doc", "n":"Médecin", "e":"🏃", "s":"Blessures, suspensions, fatigue, rotations. 80 mots max. Français."},
    {"id":"scout", "n":"L'Ancien", "e":"🧓", "s":"Patterns cachés, pièges, coaching, histoire des clubs. 80 mots max. Français."},
    {"id":"mkt", "n":"Marché", "e":"💰", "s":"Value betting + vraies cotes Bet365/Winamax. 80 mots max. Français."},
    {"id":"psy", "n":"Psychologue", "e":"🎭", "s":"Motivation, pression, derby, ambiance vestiaire. 80 mots max. Français."},
    {"id":"meteo", "n":"Météo", "e":"🌧️", "s":"Impact pluie/vent/humidité sur le match. 60 mots max. Français."},
    {"id":"juge", "n":"Juge", "e":"⚖️", "s":"Synthèse des 7 rapports. Consensus et divergences. 130 mots max. Français."},
    {"id":"pr1", "n":"Prof Pragma", "e":"🎓", "s":"Critique réaliste, failles, pieds sur terre. 100 mots max. Français."},
...
# ── PROGRESSION + FMT + RUN_SCAN + COMMANDES ───────────────────────────────
def bar(pct,size=10):
